  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.imageContainer}>
        ...
        <CustomText style={styles.createYourAccountText}>Create Your ParlayPro Account</CustomText>
        ...
        <TouchableOpacity style={styles.completeSignUpButton}>
          <CustomText style={styles.completeSignUpButtonText}>Complete Sign-Up</CustomText>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => router.push("./LoginScreen")}>
          <CustomText style={styles.loginLinkText}>Already have an account?</CustomText>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
